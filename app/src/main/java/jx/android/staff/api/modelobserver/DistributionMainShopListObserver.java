...
public class DistributionMainShopListObserver extends ViewModel {

    public MutableLiveData<ArrayList<DistributionShopItem>> distributionShopList = new MutableLiveData<>();

    public void requestDistributionShopList(String shipTimeStr) {
        Api.getInstance().getDistributionShopList(shipTimeStr, new OnHttpCallbackSub(new OnHttpCallbackListener() {
            @Override
