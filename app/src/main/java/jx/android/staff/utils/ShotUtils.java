...
//            viewSaveToImage(childView.getDrawingCache());
     ...
     * view转bitmap
     */
    public static Bitmap viewConversionBitmap(View v, boolean relayout) {
        int w = v.getWidth();
        int h = v.getHeight();
     ...
     * view转bitmap
     */
    public static Bitmap viewConversionBitmapForCicle(View v, boolean relayout) {
        int w = v.getWidth();
        int h = v.getWidth() / 3 * 4;
