...
public class Config {
    ...
    public static final String STS_SERVER_URL = "http://0.0.0.0:0000/sts/getsts";//STS 地址

    public static final String END_POINT = "oss-cn-huhehaote.aliyuncs.com";
    public static final String BUCKET_NAME = "snailhome";
    public static final String OSS_ACCESS_KEY_ID = "LTAIQpmoMX2BB5QY";
    public static final String OSS_ACCESS_KEY_SECRET = "j2K97B4kux55Ob15m6GGKjhDinKMQA";
    ...
    public static final int TYPE_NO_RESIZE = 1;
    public static final int TYPE_NO_WATER_400 = 2;
}
