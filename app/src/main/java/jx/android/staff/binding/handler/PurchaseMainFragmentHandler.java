...
import jx.android.staff.binding.handler.delegate.PurchaseMainFragmentDelegate;
import jx.android.staff.binding.handler.delegate.base.Delegate;
import jx.android.staff.binding.vm.PurchaseMainFragmentViewModel;
import jx.android.staff.utils.DateUtils;

public class PurchaseMainFragmentHandler extends BaseHandler<PurchaseMainFragmentViewModel, PurchaseMainFragmentDelegate> {

    private Long DAY = 24 * 60 * 60 * 1000L;

    public PurchaseMainFragmentHandler(Context context, PurchaseMainFragmentViewModel viewModel, PurchaseMainFragmentDelegate delegate) {
