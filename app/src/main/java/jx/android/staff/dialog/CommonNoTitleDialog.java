...
public class CommonNoTitleDialog extends Dialog implements DialogInterface.OnCancelListener {
    ...
    public CommonNoTitleDialog(Context context, String title, String cancelStr, String confirmStr, boolean showCancel, OnActionListener onConfirmListener) {
